  ...
  return (
    <div className="container mx-auto py-8 px-6 mt-20 md:mt-28 text-gray-500">
      ...
      <p className="text-lg leading-relaxed mt-4">
        La empresa ha continuado su expansión y actualmente cuenta con un equipo de alrededor de 15 colaboradores de base y 30 personas adicionales en el ramo de la albañilería. Estructuras y Proyectos de Jalisco está afiliada a la Cámara Mexicana de la Industria de la Construcción Jalisco (CMIC) y se unió al Pacto Mundial de la ONU en 2015.
      </p>
    </div>
  );
}
